...
parser.add_option(
    ...
    default=False,
    help="Use radiation downscaling in topounits",
    action="store_true",
)
# polygonal tundra:
parser.add_option(
...
parser.add_option(
    ...
    default=False,
    help="Use IM2 hillslope hydrology parameterization",
    action="store_true",
)
    ...
    if (row[0] in mysites) or (
        ...
        if not options.no_submit and options.ensemble_file != "":
            ...
            if not options.notrans:
                ...
                if options.eco2_file:
                    cases.append(
                        basecase + "_" + modelst.replace("1850", "20TR") + "_aCO2"
                    )
                    cases.append(
                        basecase + "_" + modelst.replace("1850", "20TR") + "_eCO2"
                    )
